...
The way in which you use Google services changes when you go to Firebase V9- the approach is now based on functional programming

#### Overview on Changes

> IMPORTANT METHODS: 
> https://firebase.google.com/docs/reference/js/v8/firebase.auth.Auth#methods
>
> LIST OF ALL FIREBASE SERVICES (including Auth)
> https://firebase.google.com/docs/web/setup#available-libraries

<img src="C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20220201174411302.png" alt="image-20220201174411302" style="zoom:50%;" />

<img src="C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20220201174436706.png" alt="image-20220201174436706" style="zoom:50%;" />

#### For all Sign In Processes

Set up an observer that tells a page if we're online or offline
https://firebase.google.com/docs/auth/web/start#set_an_authentication_state_observer_and_get_user_data

- Will need to save our logged in state to ContextAPI, and also save the idToken or accessToken to be able to use the Firebase SDK
- We'll need the firebase SDK to access Google services

------

#### Specific Sign in Processes

Auth using Google: 
https://firebase.google.com/docs/auth/web/google-signin

Auth with Email Verification (send magic link for each sign-in)
https://firebase.google.com/docs/auth/web/email-link-auth

Auth using Email/Password Credentials
https://firebase.google.com/docs/auth/web/password-auth

- Must not let users log into other people's accounts though
- Implement verification emails just to make sure
  https://stackoverflow.com/questions/40404567/how-to-send-verification-email-with-firebase#:~:text=This-,question%20is,-about%20how%20to





### Create new User: Sign up with email/password (v7)
...
> [https://github.com/Jason2B3/auth-learn/blob/master/src/components/store/auth-context.js](https://github.com/Jason2B3/auth-learn)		
> commit 309A , specifically auth-context.js
...
- This function should return a variable that will equal a falsy if the person is trying to access a page while not signed in
...
The import lines can be found here: 
https://firebase.google.com/docs/web/setup#available-libraries

![image-20220201163327132](C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20220201163327132.png)
