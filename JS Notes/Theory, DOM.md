...
- How long it takes for the largest element on the page to show up
- Could be a featured image, a block of text...etc

Total Blocking Time 

- How long it takes for JS to run
- The wait time blocks the rendering of the page, which is bad for UX
  We want to eliminate that as much as possible

Cumulative Layout Shift

- How much the content on your page shifts when certain things load in
- Ex. If an ad loads and displaces text that the user may be reading, that's bad
